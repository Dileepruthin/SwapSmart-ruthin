  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 bg-violet-950 shadow-md relative">
      <div className="flex items-center gap-2">
        <img src="/logo.png" alt="SwapSmart Logo" className="h-10 w-10 rounded-full" />
        <span className="text-white text-xl font-bold tracking-wide">SwapSmart</span>
      </div>
      ...
      <ul className="flex gap-6 items-center">
        ...
        >
          ...
          {aboutOpen && (
            <div className="absolute top-full mt-2 w-72 bg-violet-900 text-white rounded-md shadow-lg p-4 text-sm z-10">
              <p>
                Hi, I’m <strong>Ruthin</strong>, the creator of SwapSmart. Passionate about AI/ML and building community-driven projects for students.
              </p>
            </div>
          )}
        </li>
